...
The SATA software package and manual can also be downloaded directly from here:

- [Download SATA GUI software package (RAR, 1.26 GB)](https://github.com/ClinicalBrainLab/clinicalbrainlab.github.io/releases/download/sata-v1.0.0/SATA.rar)
- [Download SATA manual (PDF, 2 MB)](https://github.com/ClinicalBrainLab/clinicalbrainlab.github.io/releases/download/sata-v1.0.0/SATA-MANUAL.pdf)

The original dataset record remains available through [DR-NTU (Data)](https://doi.org/10.21979/N9/DMWPZK).
